...
export function Terrain(props) {
  const { nodes } = useGLTF('../../../public/models/island-large.glb')
  ...
  useControls("Terrain", {
    SAND_BASE_COLOR: { value: "#e8b568", label: "Sand" },
    GRASS_BASE_COLOR: { value: "#76a033", label: "Grass" },
  ...
  return (
    <group {...props} dispose={null}>
      <mesh 
        geometry={nodes.Plane.geometry} scale={35.113}
...
useGLTF.preload('../../../public/models/island-large.glb')
